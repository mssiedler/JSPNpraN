...
@NamedQueries({
    ...
    , @NamedQuery(name = "Joystick.findById", query = "SELECT j FROM Joystick j WHERE j.id = :id")
    , @NamedQuery(name = "Joystick.findByModelo", query = "SELECT j FROM Joystick j WHERE j.modelo = :modelo")
    , @NamedQuery(name = "Joystick.findByQuantidadeBotoes", query = "SELECT j FROM Joystick j WHERE j.quantidadeBotoes = :quantidadeBotoes")})
